  ...
  return (
    <div className="flex items-center gap-2 rounded px-3 py-1">
      ...
      <div className="ml-auto flex items-center gap-1">
        {isMuted && (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-3.5 w-3.5 text-status-dnd" title="Muted">
        ...
        {isDeafened && (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-3.5 w-3.5 text-status-dnd" title="Deafened">
