...
import type { ReadyEvent, MessageCreateEvent, PresenceUpdateEvent, ChannelCreateEvent, ChannelUpdateEvent, ChannelDeleteEvent, MemberAddEvent, MemberRemoveEvent, SenderKeyDistributionEvent, ServerErrorEvent } from './types/ws'
